...
namespace CadastroDeAlunos
{
    public class EmailService : IIdentityMessageService
    {
        ...
        {
            var remetenteEmail = "atendimento@despachantecampograndems.com.br";
            var mail = new MailMessage();
            mail.To.Add(message.Destination);
            mail.From = new MailAddress(remetenteEmail, "Teste de validação email", System.Text.Encoding.UTF8);
            //mail.Bcc.Add(modConfigemails.copia_oculta);
            ...
            {
                Credentials = new NetworkCredential(remetenteEmail, "Despachante@168"),
                Port = 587,
                Host = "smtp.despachantecampograndems.com.br",
                EnableSsl = false
            };
            try
            {
